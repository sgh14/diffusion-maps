...
for i in range(len(titles)):
    ...
    decoder.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.005), loss='mse')
    history = decoder.fit(X_train_red, X_train, epochs=750, validation_split=0.1, shuffle=False, batch_size=64, verbose=0)
